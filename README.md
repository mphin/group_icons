...
# 免责声明：
1. 本策略组图标集中使用的 Emoji 图像来源于 EmojiAll（https://www.emojiall.com） 这些图像经过处理和压缩，调整为 108 像素 × 108 像素的尺寸，以满足资源共享和学习参考需求。每个图像文件的命名中包含 EmojiAll 的名称和对应的 Unicode 表情代码，以明确标注来源。
